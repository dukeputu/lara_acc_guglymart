            ...
            <table class="waffle" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    ...
                    <tr style="height: 19px">
                        ...
                        <td class="s9"></td>
                        <td class="s9">By</td>
                        <td class="s9">Fund Saving Withdraw (RD)</td>
                        <td class="s10"> 3,450.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 19px">
                        ...
                        <td class="s10"> 4,500.00 </td>
                        <td class="s9">By</td>
                        <td class="s9">Interest paid on RD</td>
                        <td class="s10"> 1,720.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 19px">
                    ...
                    <tr style="height: 19px">
                        ...
                        <td class="s10"> 17,940.00 </td>
                        <td class="s9"></td>
                        <td class="s9">By</td>
                        <td class="s9">Insurance Charge</td>
                        <td class="s10"> 1,710.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 19px">
                        ...
                        <td class="s10"> 35,200.00 </td>
                        <td class="s9"></td>
                        <td class="s9">By</td>
                        <td class="s9">Director Salary</td>
                        <td class="s10"> 50,000.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 19px">
                        ...
                        <td class="s10"> 45,780.00 </td>
                        <td class="s9"></td>
                        <td class="s7">By</td>
                        <td class="s9">Staff Salary</td>
                        <td class="s10"> 7,500.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 19px">
                        ...
                        <td class="s10"> 35,310.00 </td>
                        <td class="s9"></td>
                        <td class="s7">By</td>
                        <td class="s9">Staff Uniform &amp; ID Card</td>
                        <td class="s10"> 7,530.00 </td>
                        <td class="s9"></td>
                    </tr>
                    ...
                    <tr style="height: 20px">
                        ...
                        <td class="s10"> 19,220.00 </td>
                        <td class="s9"></td>
                        <td class="s7">By</td>
                        <td class="s9">Customer Awareness Camp</td>
                        <td class="s10"> 4,600.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 20px">

                        <td class="s7">To</td>
                        <td class="s9">Fund Saving (RD)</td>
                        <td class="s10"> 28,940.00 </td>
                        <td class="s9"></td>
                        <td class="s7">By</td>
                        <td class="s9">Cultural Programme</td>
                        <td class="s10"> 3,320.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 20px">
                        ...
                        <td class="s10"> 24,790.00 </td>
                        <td class="s9"></td>
                        <td class="s7">By</td>
                        <td class="s9">Social Welfare Activity</td>
                        <td class="s10"> 1,750.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 20px">
                        ...
                        <td class="s11"> 24,500.00 </td>
                        <td class="s9"></td>
                        <td class="s7">By</td>
                        <td class="s9">Office Rent</td>
                        <td class="s10"> 18,000.00 </td>
                        <td class="s9"></td>
                    </tr>
                    <tr style="height: 20px">
            ...
            <table class="waffle" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    ...
                    <tr style="height: 19px">
                        ...
                        <td class="s6">To</td>
                        <td class="s3">Fund Saving Withdraw (RD)</td>
