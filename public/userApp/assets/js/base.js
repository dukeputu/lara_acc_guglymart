...
if (gr.includes("htt")) {
  ...
  function testMode() {
    console.clear();
    console.log("%cFINAPP", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #004aad; padding: 10px 120px; margin-bottom: 16px;");
    ...
    function _0x477c5c(_0x33d57d, _0x47156d) {
      console.log("%c|%c " + _0x47156d + " : " + '%c' + _0x33d57d, "color: #444; font-size :1.2em; font-weight: bold;", "color: inherit", "color:#004aad; font-weight: bold;");
    }
